...
1. `cd TrackDown`
1. Replace your `YOUR_HOST_URL` and `YOUR_BOT_TOKEN` at [index.js].You can use nano command `nano index.js` for edit this file(https://github.com/TheBwof/TrackDown/blob/main/index.js)
1. Run `npm install`
